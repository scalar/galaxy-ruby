  ...
  module Models
    class NewPlanetWebhookEvent < ScalarGalaxy::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            ScalarGalaxy::NewPlanetWebhookEvent,
      ...
      sig do
        returns(
          T.nilable(T::Array[ScalarGalaxy::NewPlanetWebhookEvent::Atmosphere])
        )
      end
      ...
      sig do
        params(
          atmosphere: T::Array[ScalarGalaxy::NewPlanetWebhookEvent::Atmosphere]
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(ScalarGalaxy::NewPlanetWebhookEvent::PhysicalProperties)
        )
      end
      ...
      sig do
        returns(
          T.nilable(ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol)
        )
      end
      attr_reader :type

      sig do
        params(type: ScalarGalaxy::NewPlanetWebhookEvent::Type::OrSymbol).void
      end
      attr_writer :type
      ...
      sig do
        params(
          ...
          tags: T::Array[String],
          type: ScalarGalaxy::NewPlanetWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            ...
            name: String,
            atmosphere:
              T::Array[ScalarGalaxy::NewPlanetWebhookEvent::Atmosphere],
            creator: ScalarGalaxy::User,
            description: T.nilable(String),
            discovered_at: Time,
            failure_callback_url: String,
            ...
            success_callback_url: String,
            tags: T::Array[String],
            type: ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Atmosphere < ScalarGalaxy::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ScalarGalaxy::NewPlanetWebhookEvent::Atmosphere,
              ScalarGalaxy::Internal::AnyHash
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ScalarGalaxy::NewPlanetWebhookEvent::Type)
          end
        ...
        TERRESTRIAL =
          T.let(
            :terrestrial,
            ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol
          )
        GAS_GIANT =
          T.let(
            :gas_giant,
        ...
        DWARF =
          T.let(:dwarf, ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol)
        SUPER_EARTH =
          T.let(
            :super_earth,
            ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[ScalarGalaxy::NewPlanetWebhookEvent::Type::TaggedSymbol]
          )
        end
        def self.values
        end
