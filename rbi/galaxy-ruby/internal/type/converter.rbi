  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(ScalarGalaxy::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              ScalarGalaxy::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: ScalarGalaxy::Internal::Type::Converter::Input,
              value: T.anything,
              state: ScalarGalaxy::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
          def self.coerce(
            ...
            state: ScalarGalaxy::Internal::Type::Converter.new_coerce_state
          )
          end
