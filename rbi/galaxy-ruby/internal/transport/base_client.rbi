      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    ScalarGalaxy::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              req:
                ScalarGalaxy::Internal::Transport::BaseClient::RequestComponents
            ).void
          end
          def validate!(req)
          end
          ...
          sig do
            params(
              request:
                ScalarGalaxy::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status: T.any(Integer, ScalarGalaxy::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(ScalarGalaxy::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req:
                ScalarGalaxy::Internal::Transport::BaseClient::RequestComponents,
              opts: ScalarGalaxy::Internal::AnyHash
            )
            .returns(
              ScalarGalaxy::Internal::Transport::BaseClient::RequestInput
            )
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: ScalarGalaxy::Internal::Type::Unknown,
          options: {}
        )
        end
