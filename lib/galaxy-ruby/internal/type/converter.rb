    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { ScalarGalaxy::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { ScalarGalaxy::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            ScalarGalaxy::FilePart.new(value)
          in ScalarGalaxy::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in true | false
              -> { ScalarGalaxy::Internal::Type::Boolean }
            in ScalarGalaxy::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [ScalarGalaxy::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: ScalarGalaxy::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in ScalarGalaxy::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in ScalarGalaxy::Internal::Type::Converter
              ...
              ScalarGalaxy::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(ScalarGalaxy::Internal::Type::Converter, T::Class[T.anything]) }
        end
